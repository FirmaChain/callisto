...
func (m *Module) parseGenesisTransactions(doc *cmtypes.GenesisDoc, appState map[string]json.RawMessage) error {
...
func (m *Module) saveValidators(doc *cmtypes.GenesisDoc, validators stakingtypes.Validator) error {
...
func (m *Module) saveValidatorDescription(doc *cmtypes.GenesisDoc, validators stakingtypes.Validator) error {
